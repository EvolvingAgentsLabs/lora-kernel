...
| **S9** | una región que es la mañana de alguien | 🟢 **la disposición a preguntar es lo que un LoRA lleva entre dominios** — la base sola no pide nada 150 veces y saca el complemento de su propia barra (39/113, p = 1,000). Un adaptador de protocolo entrenado sobre herramientas de **mecánica de fluidos** la lleva a **127 llamadas en 123 de 150 casos** sobre email — y las 127 son rechazadas, porque pide en el vocabulario que aprendió. **La conducta transfiere; los nombres no** |
