...
| **S9** | una región que es la mañana de alguien | ✅ **un QLoRA autocontenido clarea la compuerta — 84/113 = 0,743 contra una barra de 0,655, p exacta = 0,028**, con **393 llamadas y 0 rechazadas**. Pidió en 113 de 150 casos y salteó los 37 que el listado ya resuelve, así que aprendió *cuándo* preguntar. La base saca 0,345, el complemento exacto de su propia barra, de contestar NOT IMPORTANT a todo. **Sin composición, sin kernel compartido, sin torneo.** Y el uso de herramientas son dos capacidades que generalizan distinto — la base sola no pide nada 150 veces. Un kernel entrenado sobre herramientas de **mecánica de fluidos** pregunta en **123 de 150** casos sobre email y es rechazado siempre; uno entrenado sobre los **nombres de email** es rechazado **0** veces y pregunta en sólo **22**. La disposición transfiere amplia y vagamente, el vocabulario precisa y angostamente, **y ninguna sola alcanza el margen** |
